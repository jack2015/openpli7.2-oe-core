...
RDEPENDS_${PN} = " \
	${@bb.utils.contains_any("MACHINE", "dm900 dm920", "bzip2 mtd-utils mtd-utils-ubifs", "", d)} \
	${@bb.utils.contains_any("MACHINE", "dm800 dm800se", "dreambox-buildimage mtd-utils-jffs2 mtd-utils-ubifs mtd-utils ofgwrite" , "", d)} \
"
S = "${WORKDIR}/git"
